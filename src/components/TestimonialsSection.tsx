      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-12">
          <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#F5EBE1] text-[#854820] text-xs font-bold uppercase tracking-wider mb-3">
            <Star className="w-3.5 h-3.5 text-[#C68A2C] fill-[#C68A2C]" />
          ...
          <p className="text-base sm:text-lg text-[#6B5B52] mt-3">
            Real experiences from software architects, corporate executives, entrepreneurs, and government aspirants.
          </p>

          {/* Google Review Trust Badge */}
          <div className="mt-5 inline-flex items-center gap-3 bg-white px-4 py-2 rounded-full border border-[#E8DACD] shadow-sm">
